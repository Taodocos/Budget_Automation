...
import ViewAlloGrid from "../OnlyAllowance/page";
import ExpenseByDiGrid from "../viewExpenseByDistrict/page";
import AllowByDiGrid from "../AllowancwByDistrict/page";
...
const ManByDiGrid = () => {
    ...
    return (
        <div className="p-6 bg-gray-100 overflow-hidden">
               <h1  className="mb-4 p-2 border rounded text-black font-bold">Man Power Plan</h1>
            <input
                type="text"
                placeholder="Search..."
                value={searchQuery}
